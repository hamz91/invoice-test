...
var _Main = __webpack_require__(/*! ./Main.js */ "./src/components/Main.js");
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            { activeStyle: { color: "red" }, to: "/invoice-form" },
            "New Invoice"
          )
        ),
        _react2.default.createElement(
...
var InvoiceForm = function (_React$Component) {
  ...
  function InvoiceForm() {
    ...
    var _this = _possibleConstructorReturn(this, (InvoiceForm.__proto__ || Object.getPrototypeOf(InvoiceForm)).call(this));
  ...
  _createClass(InvoiceForm, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          "form",
          { className: "form", onSubmit: this.formSubmit },
          _react2.default.createElement(
            "p",
            null,
            "Your Name"
...
var _InvoiceForm = __webpack_require__(/*! ./InvoiceForm.js */ "./src/components/InvoiceForm.js");

var _InvoiceForm2 = _interopRequireDefault(_InvoiceForm);

var _PreviousInvoices = __webpack_require__(/*! ./PreviousInvoices.js */ "./src/components/PreviousInvoices.js");

var _PreviousInvoices2 = _interopRequireDefault(_PreviousInvoices);
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_reactRouterDom.Route, { exact: true, path: "/", render: function render() {
            return _react2.default.createElement(_InvoiceForm2.default, null);
          } }),
        _react2.default.createElement(_reactRouterDom.Route, { path: "/invoice-form", render: function render() {
            return _react2.default.createElement(_InvoiceForm2.default, null);
          } }),
        _react2.default.createElement(_reactRouterDom.Route, { path: "/previous-invoices", render: function render() {
            return _react2.default.createElement(_PreviousInvoices2.default, null);
          } })
      );
    }
  }]);
...
/***/ "./src/components/PreviousInvoices.js":
/*!********************************************!*\
  !*** ./src/components/PreviousInvoices.js ***!
  \********************************************/
/*! no static exports found */
...
var PreviousInvoices = function (_React$Component) {
  _inherits(PreviousInvoices, _React$Component);

  function PreviousInvoices() {
    _classCallCheck(this, PreviousInvoices);

    var _this = _possibleConstructorReturn(this, (PreviousInvoices.__proto__ || Object.getPrototypeOf(PreviousInvoices)).call(this));

    _this.state = {
      previousInvoices: {}
    };

    _this.editInvoice = _this.editInvoice.bind(_this);
    return _this;
  }

  _createClass(PreviousInvoices, [{
    ...
    key: "editInvoice",
    value: function editInvoice(invoice, status) {
      var _this3 = this;
      ...
      if (status == "Still awaiting payment") {
        ...
        }).then(fetch("/api/invoices").then(function (response) {
          return response.json();
        }).then(function (data) {
          _this3.setState({
            previousInvoices: data
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        Object.keys(this.state.previousInvoices).map(function (invoice) {
          return _react2.default.createElement(
            "div",
            { key: invoice },
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                ...
                _react2.default.createElement(
                  "p",
                  null,
                  _this4.state.previousInvoices[invoice].name
                )
              ),
              _react2.default.createElement(
                "li",
                ...
                _react2.default.createElement(
                  "p",
                  null,
                  _this4.state.previousInvoices[invoice].date
                )
              ),
              _react2.default.createElement(
                "li",
                ...
                _react2.default.createElement(
                  "p",
                  null,
                  _this4.state.previousInvoices[invoice].value
                )
              ),
              _react2.default.createElement(
                "li",
                ...
                _react2.default.createElement(
                  "p",
                  null,
                  _this4.state.previousInvoices[invoice].description
                )
              ),
              _react2.default.createElement(
                "li",
                ...
                _react2.default.createElement(
                  "p",
                  null,
                  _this4.state.previousInvoices[invoice].paid
                ),
                _react2.default.createElement(
                  "h5",
                  null,
                ...
                _react2.default.createElement(
                  "button",
                  {
                    onClick: function onClick() {
                      return _this4.editInvoice(invoice, _this4.state.previousInvoices[invoice].paid);
                    }
                  },
                  "Confirm"
                )
...
exports.default = PreviousInvoices;
